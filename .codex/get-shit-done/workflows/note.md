...
- **Global scope**: `/Users/luca/dev/gpui/helm/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/luca/dev/gpui/helm/.codex/notes/`)
...
2. Glob `/Users/luca/dev/gpui/helm/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/luca/dev/gpui/helm/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/luca/dev/gpui/helm/.codex/notes/` — works in any directory
