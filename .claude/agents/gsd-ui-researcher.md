...
Use template from `/Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/luca/dev/gpui/helm/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
