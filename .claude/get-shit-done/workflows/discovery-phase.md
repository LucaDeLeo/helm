...
See /Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/discovery.md
...
Use /Users/luca/dev/gpui/helm/.claude/get-shit-done/templates/discovery.md.
